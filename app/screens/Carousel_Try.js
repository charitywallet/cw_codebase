...
import { sliderWidth, itemWidth } from '../components/DashboardComponents/SliderEntry/styles';
import SliderEntry from '../components/DashboardComponents/SliderEntry';
import styles, { colors } from '../components/DashboardComponents/SliderEntry/extras/index.style';
import { ENTRIES1, ENTRIES2 } from '../components/DashboardComponents/SliderEntry/Static/entries';
import { scrollInterpolators, animatedStyles } from '../components/DashboardComponents/SliderEntry/extras/animations';

const IS_ANDROID = Platform.OS === 'android';
const SLIDER_1_FIRST_ITEM = 1;

class Carousel_Try extends Component {
