...
constructor(props) {
  ...
  this.state = {
    ...
    initial: true,
    dataSource: this.props.drives_data,
  };
  this.arrayholder = [];
}
...
//   console.log("Drives added", nextProps);
//   console.log("Drives added this", this.props);
...
// }
  ...
  shouldComponentUpdate(nextProps, nextState){
    console.log("inside", this.state.dataSource)
    if(nextProps.count !== this.props.count) {
      console.log("updated", this.props.count);
      // this.setState({
      //   dataSource: this.props.drives_selected,
      // })
      return true;
    }
    console.log("not updated", this.props.count);
    return false;
    // console.log("previous props", prevProps.navigation.isFocused())
    // console.log("current props", this.props.navigation.isFocused())
    //console.log("Drives added", nextState.shouldUpdate);
    ...
    // if ((nextProps.drives_added_by_user === true) || this.state.initial === true) {
    ...
    //   //this.props.drives_added_by_user = false;
    //   this.props.funcDrivesMainDisable(true);
    //   nextProps.funcDrivesMainDisable(true);
    //   // this.props.drives_added_by_user = false;
    //   // nextProps.drives_added_by_user = false;
    //   return true;
    // }
  ...
  //   console.log("componentDidUpdate Supported")
  //   this.props.funcDrivesMainDisable(true);
  //   nextProps.funcDrivesMainDisable(true);
  //   // this.props.drives_added_by_user = false;
  //   // nextProps.drives_added_by_user = false;
  ...
  componentWillUnmount(){
    console.log("unkount in supported");
  }
